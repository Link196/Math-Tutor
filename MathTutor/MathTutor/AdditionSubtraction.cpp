...
void additionSubtraction(User* p1) // combined addition and subtraction subject area
{
	cout << "You will be presented with 10 addition problems and 10 subtraction problems and then retured to the main menu." << endl;
	cout << "If, at any time, you wish to skip the current subject area, enter '-1' as your response." << endl;
	cout << endl;
	...
	for (int count2 = 1; count2 <= 10; count2++) // output ten subtraction problems in succession
	{
		int x = 5;
		int y = 5;
		...
		{
			count2 = 11; // exit the for loop to return to the main menu
		}
	}
}