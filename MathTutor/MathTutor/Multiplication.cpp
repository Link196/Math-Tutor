...
void multiplication(User* p1) // multiplication subject area
{
	cout << "You will be presented with 10 multiplication problems and then returned to the main menu." << endl;
